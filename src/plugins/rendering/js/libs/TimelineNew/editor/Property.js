...
export default class Property {
      ...
      if (lineData.properties.hasOwnProperty(key)) {
        ...
        if (!property_name || instance_prop.name === property_name) {
          ...
          if (property_name) {
            ...
            const footerProp = this.addFooter(instance_prop, lineData, key_val, $tween_container, propertyData)
  ...
  addFooter (instance_prop, lineData, key_val, $container, propertyData) {
    const footer = new PropertyFooter(instance_prop, lineData, this.editor, key_val, this.timeline)
